<template>
    <div :id="props.message.id" class="flex items-start gap-2.5 mb-2" :class="{'justify-end mr-3': props.message.owner == user?.email_address, 'ml-3': props.message.name != user?.email_address}">
