<template>
    <div class="flex items-start gap-2.5" :class="{'justify-end mr-3': props.message.sender == 'self', 'ml-3': props.message.sender != 'self'}">
        ...
        <!-- TODO -->
        <img v-if="props.message.sender != 'self'" class="w-8 h-8 rounded-full" src="" alt="Bonnie Green image">
        <div class="flex flex-col gap-1">
            <div class="flex flex-col w-full max-w-[326px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                <div class="flex items-center justify-between space-x-2 rtl:space-x-reverse mb-2">
